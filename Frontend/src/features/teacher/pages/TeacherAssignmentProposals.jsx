        ...
        <div className={Z_PAGE}>
            <div className={Z_INNER}>
                <nav className="mb-4 flex flex-wrap items-center gap-1 text-[13px] font-semibold text-[var(--text-secondary)]">
                    ...
                    <ChevronRight className="h-3.5 w-3.5 shrink-0 text-[var(--text-secondary)]" />
                    <span className="text-[var(--text-primary)]">Proposal roster</span>
                </nav>

                <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                    <div>
                        <h1 className="text-2xl font-bold tracking-tight text-[var(--text-primary)] md:text-[26px]">Proposal roster</h1>
                ...
                <div className="mb-6 grid grid-cols-2 gap-3 sm:grid-cols-4">
                    ...
                    <div className={`${Z_CARD} p-4`}>
                        ...
                        <p className="mt-2 text-2xl font-bold text-[var(--text-primary)]">{stats.needsReview}</p>
                    </div>
                    <div className={`${Z_CARD} p-4`}>
                        <div className="flex items-center gap-2 text-[var(--text-secondary)]">
                        ...
                        <p className="mt-2 text-2xl font-bold text-[var(--text-primary)]">{stats.approved}</p>
                    </div>
                    <div className={`${Z_CARD} p-4`}>
                        <div className="flex items-center gap-2 text-[var(--text-secondary)]">
                        ...
                        <p className="mt-2 text-2xl font-bold text-[var(--text-primary)]">{stats.flagged}</p>
                    </div>
                </div>

                {proposals.length === 0 ? (
                    <div className={`${Z_CARD} ${Z_EMPTY_PAD} text-sm font-semibold text-[var(--text-secondary)]`}>No proposals submitted yet.</div>
                    ...
                    <div className={`${Z_CARD} overflow-hidden`}>
                        <div className="flex items-center justify-between border-b border-[var(--border)] px-4 py-3 md:px-5">
                            ...
                            <span className="text-xs font-semibold text-[var(--text-secondary)]">{filteredProposals.length} shown</span>
                        </div>
                                ...
                                <li key={p._id}>
                                    ...
                                    >
                                        ...
                                        <div className="min-w-0 flex-1">
                                            <p className="truncate font-bold text-[var(--text-primary)]">{studentIdentityLabel(p)}</p>
                                            <p className="mt-0.5 truncate text-xs font-semibold text-[var(--text-secondary)]">{p.title || 'Untitled proposal'}</p>
                                        </div>
