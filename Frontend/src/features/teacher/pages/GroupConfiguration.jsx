 ...
 : 'border-[var(--border)] hover:border-blue-200 dark:hover:border-white/10 bg-[var(--bg-elevated)]'
                        ...
                        {projectType === 'group' && (
                            <>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                                        ...
                                        <div className="bg-[var(--bg-card)] border border-[var(--border)] p-8 rounded-[32px] flex flex-col items-start shadow-2xl hover:border-blue-500/30 transition-all">
                                            ...
                                            <button
                                                ...
                                                className="w-full py-4.5 bg-blue-600 text-white rounded-[20px] font-bold flex items-center justify-center gap-3 hover:shadow-2xl hover:shadow-blue-500/40 hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-50 uppercase tracking-widest text-sm"
                                            >
                                                {isGenerating ? (
                                                    <div className="h-5 w-5 border-2 border-white/30 border-t-white rounded-full animate-spin"></div>
                                                ) : (
                                                    <>âœ¨ Generate Randomly</>
                                                )}
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <div className="p-6 md:p-8 bg-blue-500/5 rounded-[28px] flex gap-5 border border-blue-500/10 transition-colors">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-blue-600 dark:text-blue-400 mb-1.5 uppercase tracking-wider text-sm">Important Note</h4>
                    ...
                    <div className="px-6 md:px-10 py-8 bg-[var(--bg-elevated)] border-t border-[var(--border)] flex flex-col sm:flex-row items-center justify-end gap-6 md:gap-8">
                        ...
                        <button
                            onClick={handleGenerate}
                            disabled={isGenerating || !groupAssignments.length}
                            className="w-full sm:w-auto bg-blue-600 text-white px-10 py-4.5 rounded-[20px] font-bold flex items-center justify-center gap-3 shadow-2xl shadow-blue-500/20 hover:scale-[1.02] active:scale-[0.98] transition-all uppercase tracking-[0.2em] text-sm disabled:opacity-50"
                        >
