...
function proposalStatusTone(status) {
    if (!status) return 'bg-slate-100 text-[var(--sv-muted)] dark:bg-white/5 dark:text-[var(--sv-muted)]';
...
const ClassStudentDetail = () => {
    ...
    return (
        <div className="min-h-screen bg-[var(--sv-card)] dark:bg-[#0B1120]">
            <main className="p-3 sm:p-4 md:p-6 lg:p-10 max-w-[1200px] mx-auto safe-area-px">
                ...
                <header className="mb-10 flex flex-col md:flex-row gap-6 md:items-start">
                    <div className="h-20 w-20 rounded-[24px] bg-slate-100 dark:bg-[#0F172A] border border-[var(--sv-border)] dark:border-white/5 flex items-center justify-center overflow-hidden shrink-0">
                        {photoUrl ? (
                                ...
                                <li key={a.assignmentId} className="p-6 md:p-8 hover:bg-[var(--sv-card-muted)]/80 dark:hover:bg-white/[0.02] transition-colors">
                                    <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                                        <div className="min-w-0 flex-1">
                                            ...
                                            {a.proposalTitle ? (
                                                <p className="text-sm text-[var(--sv-muted)] dark:text-[var(--sv-muted)]">
