    ...
    if (initialLoading) {
        return (
            <div className="min-h-screen bg-[#F8FAFB] flex flex-col items-center justify-center">
                <Loader2 className="h-10 w-10 text-[#1e2b72] animate-spin mb-4" />
            ...
            <div className="min-h-screen bg-[#F8FAFB] flex flex-col items-center justify-center p-4 sm:p-6 md:p-10 text-center safe-area-px">
                <div className="bg-white p-8 rounded-2xl border border-red-100 shadow-sm max-w-md w-full">
                    ...
                    <button
                        ...
                        className="bg-[#1e2b72] text-white px-6 py-2.5 rounded-[12px] font-bold shadow-lg hover:bg-blue-700 w-full"
                    >
                        Back to Directory
                    </button>
                </div>
        ...
        <div className="p-4 sm:p-6 md:p-8 lg:p-10 max-w-[1200px] mx-auto font-sans bg-[#F8FAFB] min-h-screen safe-area-px">
            ...
            <div className="bg-white rounded-[16px] border border-slate-200 shadow-sm overflow-hidden p-8">
                ...
                <section className="mb-10">
                    <h3 className="text-[13px] font-extrabold text-[#1e2b72] uppercase tracking-widest mb-6">Personal Details</h3>
                ...
                {/* 2. SUBJECT EXPERTISE */}
                <section className="mb-10">
                    <h3 className="text-[13px] font-extrabold text-[#1e2b72] uppercase tracking-widest mb-6">Subject Expertise</h3>
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <div className="w-full bg-slate-50 border border-slate-200 rounded-[12px] p-2 flex flex-wrap gap-2 items-center min-h-[52px]">
                                {skills.map(skill => (
                                    <span key={skill} className="flex items-center gap-1.5 px-3 py-1.5 bg-blue-100 text-[#1e2b72] rounded-[8px] text-[13px] font-bold">
                                        {skill}
                ...
                <section className="mb-10">
                    <h3 className="text-[13px] font-extrabold text-[#1e2b72] uppercase tracking-widest mb-6">Contact Information</h3>
                ...
                <div className="flex items-center justify-end gap-6 pt-6 border-t border-slate-100">
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="flex items-center gap-2 bg-[#1e2b72] text-white px-6 py-3.5 rounded-[12px] font-bold text-[15px] shadow-lg shadow-blue-500/25 hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        {loading ? (
