        ...
        <div className="font-sans text-[13px] transition-colors">
            <div className="flex flex-col md:flex-row items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-3 mb-3 gap-3">
                ...
                <div className="flex items-center gap-3">
                    <Link
                        to="/admin/admins/new"
                        className="inline-flex items-center gap-1.5 rounded-lg bg-[#512BD4] px-3 py-1.5 text-[12px] font-bold text-white hover:bg-blue-700 transition-colors"
                    >
                                    ...
                                    <td className="px-3 py-2">
                                        <div className="flex items-center gap-2.5">
                                            <div className="bg-blue-50 p-1.5 rounded-md">
                                                <Shield className="h-3.5 w-3.5 text-[#512BD4]" />
                                            </div>
