        ...
        <div className="md:col-span-2 lg:col-span-3">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                <div className="h-14 w-14 rounded-full border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 overflow-hidden flex items-center justify-center shrink-0">
                    {uploading ? (
                        <Loader2 className="h-5 w-5 text-[#1e2b72] animate-spin" />
                    ) : form.photo ? (
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                        ...
                        <Link
                            ...
                            className="inline-flex items-center gap-1.5 bg-[#1e2b72] text-white px-3 py-1.5 rounded-lg font-bold text-[12px] whitespace-nowrap"
                        >
                ...
                <section className="bg-white dark:bg-slate-900 rounded-xl border border-slate-100 dark:border-slate-800 p-4 shadow-sm mb-4">
                    ...
                    <form onSubmit={submitAdd} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                        ...
                        <div className="md:col-span-2 flex justify-end">
                            <button disabled={adding} className="inline-flex items-center gap-1.5 rounded-lg bg-[#1e2b72] px-4 py-2 text-[12px] font-black text-white disabled:opacity-60">
            ...
            {mode === 'edit' && (
                <section className="bg-white dark:bg-slate-900 rounded-xl border border-slate-100 dark:border-slate-800 p-4 shadow-sm mb-4">
                    ...
                    <form onSubmit={submitEdit} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                        ...
                        <div className="md:col-span-2 flex justify-end">
                            <button disabled={editing} className="inline-flex items-center gap-1.5 rounded-lg bg-[#1e2b72] px-4 py-2 text-[12px] font-black text-white disabled:opacity-60">
                ...
                <section className="bg-white dark:bg-slate-900 rounded-xl border border-slate-100 dark:border-slate-800 p-4 shadow-sm mb-4">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex justify-end">
                            <button onClick={submitImport} disabled={importing || !csvText.trim()} className="inline-flex items-center gap-1.5 rounded-lg bg-[#1e2b72] px-4 py-2 text-[12px] font-black text-white disabled:opacity-60">
                        ...
                        {filteredStudents.length === 0 ? (
                            ...
                            filteredStudents.map((student, index) => (
                                <tr key={student.studentId || index} className="group hover:bg-blue-50/30 transition-colors">
                                    ...
                                    <td className="px-3 py-2">
                                        <Link to={`/admin/students/${student.studentId || ''}`} state={{ from: location.pathname }} className="text-[12px] font-bold text-slate-800 hover:text-[#1e2b72]">
                                    ...
                                    <td className="px-3 py-2">
                                        {student.classId || student.classCode ? (
                                            <Link
                                                ...
                                                className="text-[12px] font-bold text-[#1e2b72] hover:underline"
                                            >
                                                {student.classId || student.classCode}
                                            </Link>
                                        ) : (
                                    ...
                                    <td className="px-3 py-2">
                                        <div className="flex flex-col items-center gap-1.5">
                                            {student.passcode ? (
                                                ...
                                                <button onClick={() => handleGeneratePasscode(student.studentId)} className="flex items-center gap-1.5 text-[#1e2b72] bg-blue-50 hover:bg-blue-100 px-4 py-2 rounded-[10px] text-[12px] font-bold">
