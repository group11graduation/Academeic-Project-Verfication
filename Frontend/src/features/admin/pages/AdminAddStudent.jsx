        ...
        <div className="font-sans text-[13px] text-[#0F172A] dark:text-slate-200 transition-colors">
            ...
            <div className="border-b border-slate-100 dark:border-slate-800 flex flex-col md:flex-row items-center justify-between pb-3 mb-4 gap-3 transition-colors">
                <button
                    ...
                    type="button"
                    className="flex items-center gap-1.5 text-slate-500 dark:text-slate-400 hover:text-[#263c96] dark:hover:text-blue-400 transition-all font-bold text-[12px] group"
                >
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button
                        ...
                        className="flex items-center gap-1.5 px-4 py-2 bg-[#263c96] text-white rounded-lg font-bold text-[12px] hover:bg-blue-600 transition-all disabled:opacity-70"
                    >
                    ...
                    <div className="xl:col-span-2 space-y-4">
                        ...
                        <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-100 dark:border-slate-800 shadow-sm p-4">
                            <div className="flex items-center gap-2 mb-4">
                                <User className="h-5 w-5 text-[#263c96] dark:text-blue-400" />
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg py-2 px-3 text-[13px] focus:ring-2 focus:ring-blue-500/10 focus:border-[#263c96] outline-none transition-all text-slate-800 dark:text-white"
                                    />
                                </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            value={formData.dob}
                                            onChange={handleChange}
                                            className="w-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg py-2 px-3 text-[13px] focus:ring-2 focus:ring-blue-500/10 focus:border-[#263c96] outline-none transition-all text-[#0F172A] dark:text-white"
                                        />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-100 dark:border-slate-800 shadow-sm p-4">
                            <div className="flex items-center gap-2 mb-4">
                                <Users className="h-5 w-5 text-[#263c96] dark:text-blue-400" />
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 mb-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg py-2 px-3 text-[13px] focus:ring-2 focus:ring-blue-500/10 focus:border-[#263c96] outline-none transition-all placeholder:text-slate-300 dark:placeholder:text-slate-600 text-[#0F172A] dark:text-white"
                                    />
                                </div>
                                <div>
                        ...
                        <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-100 dark:border-slate-800 shadow-sm p-4">
                            <div className="flex items-center gap-2 mb-4">
                                <FileText className="h-5 w-5 text-[#263c96] dark:text-blue-400" />
                            ...
                            <div>
                                <div className="flex items-center justify-between mb-3">
                                    ...
                                    <div className="flex items-center bg-slate-50 dark:bg-slate-800 p-1 rounded-lg">
                                        <button
                                            ...
                                            className={`px-3 py-1 text-[10px] font-black uppercase tracking-widest rounded transition-all ${certificateMode === 'local' ? 'bg-white dark:bg-slate-700 text-[#263c96] dark:text-blue-400 shadow-sm' : 'text-slate-400 dark:text-slate-500'}`}
                                        >
                                            Upload File
                                        </button>
                                        <button
                                            ...
                                            className={`px-3 py-1 text-[10px] font-black uppercase tracking-widest rounded transition-all ${certificateMode === 'url' ? 'bg-white dark:bg-slate-700 text-[#263c96] dark:text-blue-400 shadow-sm' : 'text-slate-400 dark:text-slate-500'}`}
                                        >
                                            External Link
                                        </button>
                                    </div>
                                ...
                                {certificateMode === 'local' ? (
                                    <div
                                        ...
                                        className="border-2 border-dashed border-slate-200 dark:border-slate-700 rounded-[20px] p-6 flex flex-col items-center justify-center bg-slate-50/50 dark:bg-slate-800/50 group hover:bg-slate-50 dark:hover:bg-slate-800 hover:border-[#263c96] transition-all cursor-pointer relative overflow-hidden"
                                    >
                                        <input
                                            type="file"
                                        ...
                                        {localCertificateFileName ? (
                                            <div className="flex items-center gap-3 text-slate-700 dark:text-slate-300 bg-white dark:bg-slate-800 px-6 py-3 rounded-xl shadow-sm border border-slate-100 dark:border-slate-700 z-10 w-full justify-between">
                                                <div className="flex items-center gap-3 truncate">
                                                    <FileText className="h-5 w-5 text-[#263c96] dark:text-blue-400 shrink-0" />
                                            ...
                                            <>
                                                <div className="bg-blue-50 dark:bg-blue-900/40 p-3 rounded-full mb-3 group-hover:scale-110 transition-transform text-[#263c96] dark:text-blue-400">
                                                    <Upload className="h-6 w-6" />
                                                </div>
                                                <p className="text-[14px] font-bold text-slate-700 dark:text-slate-300 mb-1">
                                                    Click to <span className="text-[#263c96] dark:text-blue-400">Upload File</span>
                                                </p>
                                    ...
                                    <div className="space-y-2">
                                        <input
                                            ...
                                            className="w-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl py-3.5 px-5 text-[14px] focus:ring-2 focus:ring-blue-500/10 focus:border-[#263c96] outline-none transition-all placeholder:text-slate-300 dark:placeholder:text-slate-600 font-medium text-[#0F172A] dark:text-slate-200"
                        ...
                        <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-100 dark:border-slate-800 shadow-sm p-4">
                            <div className="flex items-center gap-2 mb-4">
                                <GraduationCap className="h-5 w-5 text-[#263c96] dark:text-blue-400" />
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 mb-4">
                                <div className="relative">
                                    ...
                                    <select
                                        ...
                                        onChange={handleChange}
                                        className="w-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg py-2 px-3 text-[13px] appearance-none focus:ring-2 focus:ring-blue-500/10 focus:border-[#263c96] outline-none transition-all text-[#0F172A] dark:text-white font-medium"
                                    >
                            ...
                            <div className="relative">
                                ...
                                <select
                                    ...
                                    className="w-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg py-2 px-3 text-[13px] appearance-none focus:ring-2 focus:ring-blue-500/10 focus:border-[#263c96] outline-none transition-all text-slate-800 dark:text-white font-medium disabled:bg-slate-50 dark:disabled:bg-slate-800/50"
                                >
                                    {loadingClasses ? (
                    ...
                    <div className="space-y-4">
                            ...
                            <div className="flex flex-col items-center">
                                ...
                                <div className="flex items-center gap-1 bg-slate-50 dark:bg-slate-800 p-1 rounded-xl mb-6 w-full">
                                    <button
                                        ...
                                        className={`flex-1 py-1.5 text-[11px] font-black uppercase tracking-widest rounded-lg transition-all ${photoMode === 'local' ? 'bg-white dark:bg-slate-700 text-[#263c96] dark:text-blue-400 shadow-sm' : 'text-slate-400 dark:text-slate-500'
                                            }`}
                                    >
                                        Local
                                    </button>
                                    <button
                                        ...
                                        className={`flex-1 py-1.5 text-[11px] font-black uppercase tracking-widest rounded-lg transition-all ${photoMode === 'url' ? 'bg-white dark:bg-slate-700 text-[#263c96] dark:text-blue-400 shadow-sm' : 'text-slate-400 dark:text-slate-500'
                                            }`}
                                    >
                                        URL
                                    </button>
                                ...
                                {photoMode === 'local' ? (
                                    <>
                                        ...
                                        <button
                                            ...
                                            className="w-full flex items-center justify-center gap-2 bg-[#263c96] text-white py-3 rounded-xl font-bold text-[13px] shadow-lg shadow-blue-500/10 hover:bg-blue-600 transition-all mb-3"
                                        >
                                    ...
                                    <div className="w-full space-y-3">
                                        <div className="relative">
                                            <input
                                                ...
                                                className="w-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl py-3 px-4 text-[13px] focus:ring-2 focus:ring-blue-500/10 focus:border-[#263c96] outline-none transition-all placeholder:text-slate-300 dark:placeholder:text-slate-600 font-medium text-[#0F172A] dark:text-slate-200"
                                                value={photoUrl}
                        ...
                        <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-100 dark:border-slate-800 shadow-sm p-4">
                            ...
                            <div className="bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800 rounded-lg p-4 text-center space-y-1.5">
                                ...
                                <p className="text-[11px] font-bold text-[#263c96] dark:text-blue-400 uppercase tracking-wider">Automated Enrollment</p>
                            </div>
                        </div>
