        ...
        <div className="admin-page font-sans text-[13px] transition-colors duration-300">
            <div className="flex items-center justify-between mb-3 gap-2">
                <button
                    ...
                    className="flex items-center gap-2 px-3 py-1.5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-slate-600 dark:text-slate-400 font-bold text-[12px] hover:bg-slate-50 dark:hover:bg-slate-750 hover:text-[#1e2b72] transition-all group"
                >
            ...
            <div className="flex items-center gap-6 border-b border-slate-200 dark:border-slate-700 mb-4 transition-colors">
                <button
                    ...
                    className={`pb-2 text-[12px] font-bold transition-all relative ${activeTab === 'students' ? 'text-[#1e2b72]' : 'text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300'}`}
                >
                    Students
                    {activeTab === 'students' && <div className="absolute bottom-0 left-0 w-full h-[2px] bg-[#1e2b72] rounded-full" />}
                </button>
                <button
                    onClick={() => { setActiveTab('teachers'); setSearchQuery(''); }}
                    className={`pb-2 text-[12px] font-bold transition-all relative ${activeTab === 'teachers' ? 'text-[#1e2b72]' : 'text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300'}`}
                >
                    Teachers
                    {activeTab === 'teachers' && <div className="absolute bottom-0 left-0 w-full h-[2px] bg-[#1e2b72] rounded-full" />}
                </button>
            </div>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-100 dark:border-slate-700 shadow-sm p-4 mb-4">
                ...
                <button
                    ...
                    className="px-3 py-1.5 bg-[#1e2b72] text-white rounded-lg text-[12px] font-bold hover:bg-blue-600 disabled:opacity-50"
                >
                        ...
                        {activeTab === 'teachers' && (
                            <>
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-1.5 px-3 py-1.5 bg-[#1e2b72] text-white rounded-lg font-bold text-[11px] hover:bg-blue-600 transition-all disabled:opacity-50"
                                >
                                    {assigningTeacher
                                        ? 'Saving...'
                                ...
                                <div className="flex flex-col gap-2 md:flex-row md:items-start md:justify-between">
                                    ...
                                    <div className="flex shrink-0 flex-wrap items-center gap-2">
                                        ...
                                        <button
                                            ...
                                            disabled={pickedStudentProfileIds.size === 0 || assigningStudent}
                                            className="flex items-center gap-1.5 rounded-lg bg-[#1e2b72] px-3 py-1.5 text-[11px] font-bold text-white hover:bg-blue-600 disabled:opacity-50"
                                        >
                                            {assigningStudent ? (
                                                <>
                                                    ...
                                                    <li key={k}>
                                                        ...
                                                        >
                                                            <input
                                                                type="checkbox"
                                                                disabled={!canAdd}
                                                                className="h-3.5 w-3.5 shrink-0 rounded border-slate-300 text-[#1e2b72] focus:ring-[#1e2b72] disabled:cursor-not-allowed"
                                                            ...
                                                            <div className="w-28 shrink-0 text-right sm:w-32">
                                                                {assignedDisplay ? (
                                                                    <Link
                                                                        ...
                                                                        className="inline-block max-w-full truncate font-mono text-[11px] font-bold text-[#1e2b72] hover:underline"
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <div>
                                                <Link
                                                    to={`/admin/${activeTab}/${activeTab === 'students' ? item.studentId : item.teacherId}`}
                                                    state={{ from: location.pathname }}
                                                    className="text-[12px] font-bold text-[#0F172A] dark:text-white hover:text-[#1e2b72] transition-colors line-clamp-1"
                                                >
                                            ...
                                            <div className="flex flex-wrap gap-1.5 max-w-md">
                                                {(item.subjects || []).length ? (
                                                    item.subjects.map((sub) => (
                                                        <span
                                                            key={sub._id}
                                                            className="inline-flex rounded-md bg-blue-50 dark:bg-blue-500/10 px-1.5 py-0.5 text-[10px] font-bold text-[#1e2b72]"
                                                        >
                                                            {sub.name}
                                                            {sub.code ? ` (${sub.code})` : ''}
                                                        </span>
