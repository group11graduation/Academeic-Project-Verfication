...
const AdminImportExport = () => {
    ...
    const btnPrimary = 'px-3 py-1.5 rounded-lg bg-[#263c96] text-white font-bold text-[11px] hover:bg-blue-700 disabled:opacity-60';
    ...
    return (
        <div className="font-sans text-[13px]">
            <div className="flex items-center gap-2 border-b border-slate-200 dark:border-slate-800 pb-3 mb-4">
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-blue-50 text-[#263c96]">
