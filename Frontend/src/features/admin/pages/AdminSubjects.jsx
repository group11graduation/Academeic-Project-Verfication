            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-3 mb-4 gap-3">
                ...
                <div className="flex items-center gap-2 justify-between sm:justify-end">
                    <button
                        ...
                        className="flex items-center gap-1.5 px-3 py-1.5 bg-[#512BD4] text-white rounded-lg font-bold text-[12px] hover:bg-blue-700 transition-colors shadow-sm"
                    >
                    ...
                    <form id="subjectForm" onSubmit={handleSubmit} className="space-y-3">
                        ...
                        <div className="flex justify-end gap-2 border-t border-slate-100 pt-3">
                            ...
                            <button
                                type="submit"
                                disabled={submitting}
                                className="px-5 py-1.5 rounded-lg font-bold text-[12px] bg-[#512BD4] text-white hover:bg-blue-700 flex items-center gap-1.5 min-w-[120px] justify-center"
                            >
            ...
            {loading ? (
                ...
                <div className="bg-white dark:bg-slate-800 rounded-xl p-8 text-center border border-slate-200 dark:border-slate-700">
                    <div className="bg-blue-50 dark:bg-blue-500/10 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3">
                        <BookOpen className="h-6 w-6 text-[#512BD4]" />
                    </div>
                    ...
                    <button type="button" onClick={openCreateModal} className="px-4 py-1.5 bg-[#512BD4] text-white rounded-lg font-bold text-[12px] inline-flex items-center gap-1.5 hover:bg-blue-700">
                        ...
                        <section key={faculty}>
                            ...
                            <div className="p-3 border-b border-slate-100 dark:border-slate-700 flex justify-between items-start gap-2">
                                ...
                                <div className="flex gap-1 shrink-0">
                                    <button type="button" onClick={() => openEditModal(sub)} className="w-7 h-7 rounded-full bg-slate-50 border border-slate-100 hover:bg-slate-100 flex items-center justify-center text-slate-400 hover:text-[#512BD4]">
                                    ...
                                    {(sub.allocations || []).length === 0 ? (
                                        ...
                                        (sub.allocations || []).map((alloc, idx) => (
                                            <div key={idx} className="flex items-center gap-2 bg-white dark:bg-slate-800 p-2 rounded-lg border border-slate-100 dark:border-slate-700">
                                                <div className="flex items-center gap-1 bg-[#512BD4]/10 text-[#512BD4] px-2 py-0.5 rounded flex-shrink-0">
