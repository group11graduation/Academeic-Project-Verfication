        ...
        <div className="max-w-lg font-sans">
            ...
            <form onSubmit={onSubmit} className="space-y-4 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                    ...
                    <div className="rounded-xl border border-slate-200 bg-slate-50 p-3">
                        ...
                        <div className="inline-flex items-center gap-2 rounded-lg border border-slate-200 bg-white px-3 py-2">
                            ...
                            <button
                                ...
                                className="text-slate-500 hover:text-[#512BD4] transition-colors"
                                title="Copy passcode"
                            >
                ...
                <button
                    type="submit"
                    disabled={submitting}
                    className="inline-flex items-center gap-2 rounded-xl bg-[#512BD4] px-6 py-3 text-[14px] font-bold text-white hover:bg-blue-700 disabled:opacity-50"
                >
