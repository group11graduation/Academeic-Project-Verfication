            ...
            <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-200 pb-3 dark:border-white/10">
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <p className="mt-0.5 text-[11px] text-slate-500 dark:text-slate-400">
                            ...
                            <Link to="/admin/academic-structure" className="font-bold text-[#512BD4] hover:underline">
                ...
                <div className="flex flex-wrap items-center gap-2">
                    ...
                    <button
                        ...
                        className="inline-flex items-center gap-1.5 rounded-lg bg-[#512BD4] px-3 py-1.5 text-[12px] font-bold text-white hover:bg-blue-700"
                    >
                        <Plus className="h-3.5 w-3.5" />
                        Add Semester
                    </button>
                ...
                >
                    ...
                    <div className="flex items-center justify-end gap-2 pt-1">
                        ...
                        <button
                            ...
                            className="inline-flex items-center gap-1.5 rounded-lg bg-[#512BD4] px-4 py-1.5 text-[12px] font-bold text-white hover:bg-blue-700 disabled:opacity-60"
                        >
