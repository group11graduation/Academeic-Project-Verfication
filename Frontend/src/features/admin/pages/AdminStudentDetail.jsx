    ...
    if (error || !student) {
        return (
            <div className="min-h-[40vh] flex flex-col items-center justify-center">
                ...
                <button onClick={() => navigate(backPath)} className="text-[#263c96] font-medium underline text-[12px]">Go Back</button>
            </div>
        );
    }
            ...
            <div className="mb-4">
                                    ...
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <button
                                                ...
                                                className="px-4 py-2 bg-blue-50 dark:bg-blue-500/10 text-[#263c96] rounded-lg text-[12px] font-black uppercase tracking-widest hover:bg-blue-100 dark:hover:bg-blue-500/20 transition-all flex items-center gap-3"
                                            >
                                ...
                                <span className="text-[#263c96]">
                                    Class: {isEditing ? (
                                        <select
                                            ...
                                            className="border-b border-blue-500 bg-slate-50 dark:bg-slate-900 outline-none text-[#263c96] dark:text-blue-400 font-bold px-2 rounded-t-md text-slate-900 dark:text-white transition-colors"
                                        >
                                            {loadingClasses ? (
                ...
                <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
                    ...
                    <div className="xl:col-span-2 space-y-4">
                        ...
                        <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-100 dark:border-slate-700 shadow-sm overflow-hidden transition-colors">
                            <div className="px-4 py-3 border-b border-slate-50 dark:border-slate-700 flex items-center justify-between transition-colors">
                                <div className="flex items-center gap-2">
                                    <User className="h-4 w-4 text-[#263c96]" />
                                ...
                                <button className="flex items-center gap-1.5 px-3 py-1.5 bg-blue-50 dark:bg-blue-500/10 text-[#263c96] rounded-lg font-bold text-[12px] hover:bg-blue-100 dark:hover:bg-blue-500/20 transition-all">
                        ...
                        <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-100 dark:border-slate-700 shadow-sm overflow-hidden transition-colors">
                            <div className="px-4 py-3 border-b border-slate-50 dark:border-slate-700 flex items-center gap-2 transition-colors">
                                <GraduationCap className="h-4 w-4 text-[#263c96]" />
                                        ...
                                        <div className="border border-slate-200 dark:border-slate-700 rounded-xl p-4 bg-slate-50 dark:bg-slate-900/50 space-y-4 transition-colors">
                                            <div className="flex bg-white dark:bg-slate-800 p-1 rounded-lg border border-slate-200 dark:border-slate-700 w-full sm:max-w-xs transition-colors">
                                                <button
                                                    ...
                                                    className={`flex-1 py-1.5 text-[11px] font-black uppercase tracking-widest rounded-md transition-all ${certEditMode === 'local' ? 'bg-[#263c96] text-white shadow-sm' : 'text-slate-500 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-700'}`}
                                                >
                                                    Upload File
                                                </button>
                                                <button
                                                    ...
                                                    className={`flex-1 py-1.5 text-[11px] font-black uppercase tracking-widest rounded-md transition-all ${certEditMode === 'url' ? 'bg-[#263c96] text-white shadow-sm' : 'text-slate-500 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-700'}`}
                                                >
                                                    External Link
                                                </button>
                                            </div>
                                            ...
                                            {certEditMode === 'local' ? (
                                                <div>
                                                    ...
                                                    <button
                                                        ...
                                                        className="w-full flex items-center justify-center gap-2 bg-white dark:bg-slate-800 border-2 border-dashed border-blue-200 dark:border-blue-500/20 text-[#263c96] py-4 rounded-xl font-bold text-[13px] hover:bg-blue-50 dark:hover:bg-blue-500/10 transition-all transition-colors"
                                                    >
                                            ...
                                            <div className="border border-slate-200 dark:border-slate-700 rounded-xl p-4 flex items-center justify-between bg-slate-50 dark:bg-slate-900/50 transition-colors">
                                                <div className="flex items-center gap-3 truncate pr-4">
                                                    <div className="bg-blue-100 dark:bg-blue-500/10 p-2 rounded-lg shrink-0 transition-colors">
                                                        <FileText className="h-4 w-4 text-[#263c96]" />
                                                    </div>
                                                ...
                                                <div className="flex items-center gap-2 shrink-0">
                                                    <button
                                                        ...
                                                        className="flex items-center gap-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 px-4 py-2 rounded-lg text-[13px] font-bold hover:bg-slate-50 dark:hover:bg-slate-700 hover:text-[#263c96] transition-all shadow-sm"
                                                    >
                                                    ...
                                                    <a
                                                        ...
                                                        className="flex items-center gap-2 bg-[#263c96] text-white px-4 py-2 rounded-lg text-[13px] font-bold hover:bg-blue-600 transition-all shadow-sm shadow-blue-500/10"
                                                    >
                        ...
                        <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-100 dark:border-slate-700 shadow-sm overflow-hidden transition-colors">
                            <div className="px-4 py-3 border-b border-slate-50 dark:border-slate-700 flex items-center gap-2 transition-colors">
                                <Users className="h-4 w-4 text-[#263c96]" />
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-100 dark:border-slate-700 shadow-sm overflow-hidden transition-colors">
                            <div className="px-4 py-3 border-b border-slate-50 dark:border-slate-700 flex items-center gap-2 transition-colors">
                                <BookOpen className="h-4 w-4 text-[#263c96]" />
                        ...
                        <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-100 dark:border-slate-700 shadow-sm overflow-hidden transition-colors">
                            <div className="px-4 py-3 border-b border-slate-50 dark:border-slate-700 flex items-center gap-2 transition-colors">
                                <ShieldCheck className="h-4 w-4 text-[#263c96]" />
                            ...
                            <div className="p-4 space-y-3">
                                    ...
                                    <div className="flex items-center justify-between gap-3">
                                        <div className="inline-flex items-center gap-2 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 px-3 py-1.5">
                                            ...
                                            <button
                                                ...
                                                className="text-slate-500 hover:text-[#263c96] transition-colors disabled:opacity-60"
                                                title="Copy passcode"
                                            >
                                ...
                                <button className="w-full flex items-center justify-between p-3 border border-slate-100 dark:border-slate-700 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-750 transition-all group transition-colors">
                                    <div className="flex items-center gap-3">
                                        <Lock className="h-4 w-4 text-slate-400 group-hover:text-[#263c96] transition-colors" />
                    ...
                    <div className="bg-white dark:bg-slate-900 w-full max-w-3xl max-h-[90vh] rounded-xl shadow-2xl overflow-hidden flex flex-col relative animate-in zoom-in-95 duration-200">
                        ...
                        <div className="px-4 py-3 border-t border-slate-100 dark:border-slate-800 flex justify-end gap-2 bg-white dark:bg-slate-900">
                            ...
                            <a 
                                href={student.educationalBackground?.certificateUrl} 
                                download="High_School_Certificate"
                                className="flex items-center gap-1.5 bg-[#263c96] text-white px-4 py-2 rounded-lg font-black text-[12px] uppercase tracking-widest hover:bg-blue-600 transition-all shadow-md shadow-blue-500/10 active:scale-[0.98]"
                            >
