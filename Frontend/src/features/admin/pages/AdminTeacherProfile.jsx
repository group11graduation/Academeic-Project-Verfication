        ...
        <div className="font-sans text-[13px] transition-colors">
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm p-4 mb-4 flex flex-col md:flex-row items-center gap-4 transition-all text-center md:text-left">
                ...
                <div className="flex-1 shrink-0">
                    ...
                    <div className="flex gap-2 justify-center md:justify-start flex-wrap">
                        <button className="flex items-center gap-1.5 px-3 py-2 bg-[#263c96] text-white rounded-lg font-bold text-[12px] hover:bg-blue-700 transition-colors">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
                ...
                <div className="space-y-4">
                            ...
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        >
                                            {showPasscode ? <EyeOff className="h-5 w-5 text-slate-400 dark:text-slate-500" /> : <Eye className="h-5 w-5 text-[#263c96]" />}
                                        </button>
                                    </div>
                                </div>
                                <div className="bg-blue-100/50 dark:bg-blue-500/10 p-2 rounded-lg text-[#263c96] transition-colors">
                    ...
                    <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm p-4 transition-all">
                        <div className="flex items-center gap-2 mb-4">
                            <BarChart2 className="h-4 w-4 text-[#263c96]" />
                        ...
                        <div className="space-y-3">
                            <div className="bg-slate-50 dark:bg-slate-900/50 p-3 rounded-lg border border-slate-100 dark:border-slate-700 flex items-center justify-between transition-colors">
                                <div>
                                    ...
                                    <p className="text-xl font-extrabold text-[#263c96] leading-none">{stats.reviewed}</p>
                                </div>
                                <div className="w-8 h-8 rounded-full bg-blue-100 dark:bg-blue-500/10 flex items-center justify-center text-[#263c96] transition-colors">
                    ...
                    <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm p-4 transition-all">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <button
                                ...
                                className="flex items-center gap-1.5 px-3 py-1.5 bg-blue-50 dark:bg-blue-500/10 text-[#263c96] rounded-lg font-bold text-[12px] hover:bg-blue-100 dark:hover:bg-blue-500/20 transition-all"
                            >
                            ...
                            {teacher.classes && teacher.classes.length > 0 ? (
                                teacher.classes.map((cls) => (
                                    <Link
                                        ...
                                        className="border border-slate-200 dark:border-slate-700 rounded-lg p-3 hover:shadow-md hover:border-[#263c96]/40 transition-all group relative overflow-hidden bg-white dark:bg-slate-800/50"
                                    >
                                        ...
                                        <div className="relative z-10">
                                            ...
                                            <div className="flex items-center justify-end">
                                                <span className="flex items-center gap-1 text-[11px] font-bold text-slate-400 group-hover:text-[#263c96] transition-colors">
                                                    View class
                                            ...
                                            {openTo ? (
                                                ...
                                                >
                                                    ...
                                                    <div className="flex items-center gap-2 shrink-0 text-[11px] font-bold text-slate-500">
                                                        <span>{when}</span>
                                                        <ArrowRight className="h-3.5 w-3.5 text-[#263c96]" />
                                                    </div>
                                                </Link>
                                            ) : (
                    ...
                    <div className="bg-white dark:bg-slate-800 rounded-xl w-full max-w-xl shadow-2xl overflow-hidden border border-white/20 dark:border-slate-700 animate-in fade-in zoom-in duration-200">
                                    ...
                                    allClasses.map(cls => (
                                        <button
                                            ...
                                            className={`flex items-center justify-between p-3 rounded-lg border-2 transition-all group ${selectedClasses.includes(cls.code)
                                                ? 'border-[#263c96] bg-blue-50/30 dark:bg-blue-500/10 ring-4 ring-blue-500/5'
                                        ...
                                        >
                                            ...
                                            <div className={`h-7 w-7 rounded-full border-2 flex items-center justify-center transition-all ${selectedClasses.includes(cls.code)
                                                ? 'bg-[#263c96] border-[#263c96] text-white scale-110'
                        ...
                        <div className="p-4 border-t border-slate-100 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-900/50 flex items-center justify-between transition-colors">
                            <div className="flex items-center gap-2">
                                ...
                                <p className="text-[12px] font-black text-[#263c96] uppercase tracking-wider">
                            ...
                            <div className="flex gap-2">
                                ...
                                <button
                                    ...
                                    className="px-5 py-2 bg-[#263c96] text-white rounded-lg font-black text-[12px] hover:bg-blue-600 transition-all flex items-center gap-1.5 disabled:opacity-70"
                                >
