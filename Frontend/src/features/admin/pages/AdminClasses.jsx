...
const AdminClasses = () => {
    ...
    const getCategoryStyles = (category) => {
        switch (category) {
            case 'ACADEMIC':
                return { color: 'bg-gradient-to-br from-[#2f4aad] to-[#3B82F6]', icon: GraduationCap };
            case 'LAB BASED':
                return { color: 'bg-gradient-to-br from-[#2f4aad] to-[#2563EB]', icon: Beaker };
            case 'THEORY':
                return { color: 'bg-gradient-to-br from-[#3B82F6] to-[#60A5FA]', icon: BookOpen };
            case 'WORKSHOP':
                return { color: 'bg-[#1E293B]', icon: Code2 };
            case 'SEMINAR':
                return { color: 'bg-gradient-to-br from-[#2f4aad] to-[#0EA5E9]', icon: Calculator };
            default:
