    ...
    if (loading) {
        return (
            <div className="flex min-h-[40vh] items-center justify-center">
                <Loader2 className="h-10 w-10 animate-spin text-[#263c96]" />
            </div>
        );
    }
    ...
    return (
        <div className="max-w-lg font-sans">
            ...
            <form onSubmit={onSave} className="space-y-4 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <button
                    type="submit"
                    className="inline-flex items-center gap-2 rounded-xl bg-[#263c96] px-6 py-3 text-[14px] font-bold text-white hover:bg-blue-700"
                >
                    Save
                </button>
            </form>
