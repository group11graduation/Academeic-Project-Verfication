        ...
        <div className="w-full font-sans">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-[16px] border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden p-8">
                ...
                <section className="mb-10">
                    <h3 className="text-[13px] font-extrabold text-[#512BD4] dark:text-blue-400 uppercase tracking-widest mb-6">Personal Details</h3>
                ...
                {/* 2. SUBJECT EXPERTISE */}
                <section className="mb-10">
                    <h3 className="text-[13px] font-extrabold text-[#512BD4] dark:text-blue-400 uppercase tracking-widest mb-6">Subject Expertise</h3>
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <div className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-[12px] p-2 flex flex-wrap gap-2 items-center min-h-[52px]">
                                {skills.map(skill => (
                                    <span key={skill} className="flex items-center gap-1.5 px-3 py-1.5 bg-blue-100 dark:bg-blue-900/40 text-[#512BD4] dark:text-blue-400 rounded-[8px] text-[13px] font-bold">
                                        {skill}
                ...
                <section className="mb-10">
                    <h3 className="text-[13px] font-extrabold text-[#512BD4] dark:text-blue-400 uppercase tracking-widest mb-6">Contact Information</h3>
