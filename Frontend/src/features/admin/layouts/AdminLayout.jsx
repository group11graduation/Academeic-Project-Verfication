...
const AdminLayoutInner = () => {
    ...
    const linkIdle = `${linkRow} mx-0.5 rounded-lg px-2.5 py-1.5 font-semibold text-slate-600 hover:bg-slate-100 hover:text-slate-900`;
    const linkActive = `${linkRow} mx-0.5 rounded-lg px-2.5 py-1.5 font-bold text-[#1e56e3] bg-blue-50 ring-1 ring-[#1e56e3]/12`;
    const iconBox =
        'flex h-[28px] w-[28px] shrink-0 items-center justify-center rounded-md bg-slate-100 text-slate-500 ring-1 ring-slate-200/80';
    const iconBoxActive =
        ...
        <div className="flex h-[100dvh] max-h-[100dvh] min-h-0 w-full max-w-full flex-col overflow-hidden bg-[#f8fafc] font-sans antialiased">
            ...
            <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden lg:flex-row">
                ...
                >
                    <div className="flex h-full max-h-[100dvh] overflow-hidden rounded-r-[16px] bg-white shadow-[6px_0_24px_-18px_rgba(15,23,42,0.2)] ring-1 ring-slate-200">
                        ...
                        {!isSidebarCollapsed && <>
                            ...
                            <div className="mt-auto border-t border-slate-200 px-2 pb-3 pt-2">
                                <button
                                    type="button"
                                    onClick={requestLogout}
                                    className="mx-1 flex w-[calc(100%-0.5rem)] items-center gap-2 rounded-lg px-2 py-1.5 text-[11px] font-semibold text-slate-600 transition-colors hover:bg-rose-50 hover:text-rose-700"
                                >
                                    <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-md bg-slate-100 text-slate-500 ring-1 ring-slate-200/80">
                ...
                <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden bg-[#f8fafc]" style={{ backgroundColor: CONTENT_BG }}>
                    <header className="flex h-[52px] shrink-0 items-center justify-between gap-2 bg-gradient-to-r from-[#f4f7ff] via-white to-[#f4f7ff] px-3 sm:px-4 lg:px-5">
                        <div className="min-w-0">
                            <div className="text-[12px] font-extrabold leading-tight text-[#1d2f82]">Welcome back</div>
                            <div className="text-[10px] font-semibold text-[#51628f]">Admin Dashboard</div>
                        </div>
