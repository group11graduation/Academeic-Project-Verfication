        ...
        <div className="min-h-screen overflow-x-hidden bg-[#f8faff] font-sans text-[var(--sv-text)] selection:bg-blue-100 selection:text-blue-900 dark:bg-[#020617] dark:text-slate-100">
            ...
            <section className="pt-24 pb-16 px-6">
                <div className="max-w-[1400px] mx-auto">
                    ...
                    <p className="mb-10 max-w-2xl text-lg font-medium text-[var(--sv-muted)] dark:text-slate-300">
            ...
            {/* Mission Section */}
            <section className="bg-[var(--sv-card-muted)] px-6 py-24 dark:bg-[#0b1220]">
                <div className="max-w-[1536px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center px-3 sm:px-4 safe-area-px">
                    <div className="space-y-8">
                        ...
                        <h2 className="text-4xl font-black leading-tight text-[var(--sv-text)] dark:text-slate-100 md:text-5xl">
                            Fostering Honesty in Academic Projects
                        </h2>
                        
                        <div className="space-y-6 text-lg font-medium leading-relaxed text-[var(--sv-muted)] dark:text-slate-300">
                            <p>
                        ...
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 pt-6">
                            <div className="flex gap-4 rounded-3xl border border-[var(--sv-border)] bg-[var(--sv-card)] p-6 shadow-sm dark:border-white/10 dark:bg-[#111827]">
                                <div className="text-[#1D68E3] bg-blue-50 dark:bg-blue-500/15 p-3 rounded-2xl h-fit">
                                    <Sparkles className="h-6 w-6" />
                                </div>
                                <div>
                                    <h4 className="mb-1 font-bold text-[var(--sv-text)] dark:text-slate-100">Originality</h4>
                                    <p className="text-sm text-[var(--sv-muted)] dark:text-[var(--sv-muted)]">Promoting unique research</p>
                                </div>
                            </div>
                            <div className="flex gap-4 rounded-3xl border border-[var(--sv-border)] bg-[var(--sv-card)] p-6 shadow-sm dark:border-white/10 dark:bg-[#111827]">
                                ...
                                <div>
                                    <h4 className="mb-1 font-bold text-[var(--sv-text)] dark:text-slate-100">Equality</h4>
                                    <p className="text-sm text-[var(--sv-muted)] dark:text-[var(--sv-muted)]">Fair grading for all students</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="relative lg:h-[600px] flex items-center justify-center">
                        ...
                        {/* UI Mockup Card */}
                        <div className="group relative w-full max-w-md overflow-hidden rounded-[40px] border border-[var(--sv-border)] bg-[var(--sv-card)] p-8 pt-10 shadow-2xl shadow-slate-200/50 dark:border-white/10 dark:bg-[#111827] dark:shadow-none">
                           {/* Subtle grid background on the card */}
                            ...
                            <div className="relative z-10 space-y-8">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="h-3 w-full overflow-hidden rounded-full bg-[var(--sv-card-muted)] dark:bg-slate-800">
                                        <div className="h-full bg-blue-600 w-[98%] rounded-full shadow-[0_0_10px_rgba(37,99,235,0.5)]"></div>
                                    </div>
                                    
                                    {/* Skeleton Text Lines */}
                                    <div className="space-y-2.5 pt-4">
                                        <div className="h-3 w-full animate-pulse rounded-md bg-[var(--sv-card-muted)] dark:bg-slate-800"></div>
                                        <div className="delay-75 h-3 w-[85%] animate-pulse rounded-md bg-[var(--sv-card-muted)] dark:bg-slate-800"></div>
                                        <div className="delay-150 h-3 w-[92%] animate-pulse rounded-md bg-[var(--sv-card-muted)] dark:bg-slate-800"></div>
                                        <div className="delay-200 h-3 w-[78%] animate-pulse rounded-md bg-[var(--sv-card-muted)] dark:bg-slate-800"></div>
                                    </div>
                                </div>

                                <div className="mt-8 flex items-center gap-3 border-t border-[var(--sv-border)] pt-6 dark:border-white/10">
                                    <div className="w-8 h-8 rounded-full bg-emerald-100 flex items-center justify-center text-emerald-600">
                                        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="3">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                                        </svg>
                                    </div>
                                    <span className="text-sm font-bold text-[var(--sv-muted)] dark:text-slate-300">Verified by NLP Engine</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            {/* Technology Section */}
            <section id="technology" className="bg-[var(--sv-card)] px-6 py-32 dark:bg-[#020617]">
                <div className="max-w-[1536px] mx-auto">
                    <div className="text-center max-w-3xl mx-auto mb-20">
                        <h2 className="mb-6 text-4xl font-black tracking-tight text-[var(--sv-text)] dark:text-slate-100 md:text-5xl">Advanced ML & NLP Technology</h2>
                        <p className="text-xl font-medium text-[var(--sv-muted)] dark:text-slate-300">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={i} className="group rounded-2xl sm:rounded-3xl lg:rounded-[2rem] border border-[var(--sv-border)] bg-[var(--sv-card-muted)] p-4 sm:p-6 lg:p-10 transition-all duration-300 hover:bg-[var(--sv-card-muted)] hover:shadow-xl hover:shadow-slate-200/50 dark:border-white/10 dark:bg-[#0f172a] dark:hover:bg-[#111827] dark:hover:shadow-none min-w-0">
                                ...
                                <h3 className="mb-4 text-2xl font-black text-[var(--sv-text)] dark:text-slate-100">{feature.title}</h3>
                                <p className="font-medium leading-relaxed text-[var(--sv-muted)] dark:text-slate-300">{feature.desc}</p>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            {/* Team Section */}
            <section id="team" className="bg-[var(--sv-card-muted)] px-6 py-32 dark:bg-[#0b1220]">
                <div className="max-w-[1536px] mx-auto">
                    <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
                        <div className="max-w-xl">
                            <h2 className="mb-4 text-4xl font-black tracking-tight text-[var(--sv-text)] dark:text-slate-100 md:text-5xl">Meet the Team</h2>
                            <p className="text-lg font-medium text-[var(--sv-muted)] dark:text-slate-300">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        {team.map((member, i) => (
                            <div key={i} className="group cursor-pointer">
                                ...
                                <h3 className="mb-1 text-2xl font-black text-[var(--sv-text)] dark:text-slate-100">{member.name}</h3>
                            </div>
                        ))}
                    </div>
                </div>
