...
export const Z_BTN_PRIMARY =
    'inline-flex min-h-[44px] items-center justify-center gap-1.5 rounded-lg bg-[var(--accent)] px-3 py-2 text-[12px] font-bold text-white shadow-sm transition hover:brightness-110 disabled:pointer-events-none disabled:opacity-50 sm:min-h-0 sm:py-1.5';
...
export const Z_LINK = 'text-[var(--accent)] font-semibold hover:underline text-[12px]';
export const Z_INPUT =
    'w-full min-w-0 rounded-lg border border-[var(--sv-border)] bg-[var(--sv-card)] px-2.5 py-2.5 text-base sm:text-[12px] font-medium text-[var(--sv-text)] outline-none transition focus:border-[var(--accent)]/35 focus:ring-2 focus:ring-[var(--accent)]/15 sm:py-2';
...
export const Z_BTN_SUBMIT = 'inline-flex w-full min-h-[44px] items-center justify-center gap-1.5 rounded-lg bg-[var(--accent)] px-4 py-2.5 text-[12px] font-bold text-white hover:brightness-110 disabled:opacity-60 sm:min-h-0 sm:py-2';
export const Z_BTN_INDIGO = 'inline-flex w-full items-center justify-center gap-1.5 rounded-lg bg-[var(--accent)] px-4 py-2 text-[12px] font-bold text-white hover:brightness-110 disabled:opacity-60';
...
export const Z_PANEL =
    'min-w-0 overflow-hidden rounded-2xl border border-[var(--border)] bg-[var(--bg-card)] p-4 shadow-sm sm:rounded-3xl sm:p-6 lg:rounded-[2rem] lg:p-8';
