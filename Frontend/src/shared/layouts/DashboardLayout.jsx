...
import { PROJECT_NAME } from '../ui/brandTheme';
import {
    ADMIN,
...
/** Teacher console shell — same structure and chrome as AdminLayout. */
...
const DashboardLayoutInner = ({ children }) => {
    ...
    const navSections = useMemo(() => {
        const sections = [
            ...
            },
            {
                ...
                name: 'Classes',
                icon: Users,
                links: [{ name: 'My Classes', path: '/teacher/classes', icon: Users }],
            },
            {
                key: 'workflow',
                name: 'Workflow',
        ...
        if (hasAdminRole) {
            sections.push({
                ...
                name: 'Admin Panel',
                icon: Shield,
                links: [{ name: 'Admin Panel', path: '/admin', icon: Shield }],
            });
        }
        return sections;
    }, [hasAdminRole]);
    ...
    const displayName = (user?.name || 'Teacher').trim();
            ...
            >
                ...
                <div className="flex shrink-0 items-center gap-2">
                    ...
                    <button
                        ...
                        className="flex h-10 w-10 items-center justify-center rounded-lg border border-[var(--border)] bg-[var(--bg-elevated)] text-[var(--text-primary)]"
                                                ...
                                                {links.map((item) => {
                                                    ...
                                                    return (
                                                        <NavLink
                                                            ...
                                                            className={({ isActive }) =>
                                                                isActive ? childActiveClass : childIdleClass
                                                            }
                                                        >
                                                            {({ isActive }) => (
                                                                <>
                        ...
                        <div className="border-b border-[var(--border)] bg-gradient-to-r from-[#f4f7ff] via-white to-[#f4f7ff] px-4 py-4 sm:px-5">
                            <div className="flex items-start gap-3">
                                <div
                                    ...
                                    style={{ backgroundColor: SHELL_BLUE }}
                                >
